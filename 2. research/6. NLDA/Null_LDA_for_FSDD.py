...
class Null_LDA:
    ...
    def CLASS_INFORMATION(self, file):
        ...
        for key in N_class_sample:
            for index in range(N_data):
                print(int(key), int(file[index]))
                if int(key) == int(file[index]):
