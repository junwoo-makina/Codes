...
if __name__ == "__main__":
    ...
    for val in range(1,9):              # Set order 1~8
        ...
        for missing_rate in range(1,11):
                ...
                for epoch in range(FLAGS.max_epoch):
                    ...
                    for i in range(FLAGS.updates_per_epoch-1):
                        ...
                        x, g = generate_train_batch(
                            tr_data[i*FLAGS.batch_size:(i+1)*FLAGS.batch_size,:FLAGS.input_size], epoch, FLAGS.batch_size)
                        tx = generate_test_batch(te_data[missing_rate-1], 20, 130, int(32000*(100-missing_rate*5)/100))
